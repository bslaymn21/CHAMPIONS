...
//                 // عرض تفاصيل الإشعار (يمكن توسيع هذه الوظيفة)
...
//         // يمكن توسيع هذه الوظيفة للبحث في النشاطات أو الإحصائيات
...
//         // يمكن توسيع هذه الوظيفة لعرض تفاصيل النشاط
...
//                             <button class="action-btn view" title="عرض" onclick="appManager.viewMember('${member.id}')">
//                                 <i class="fas fa-eye"></i>
//                             </button>
//                             <button class="action-btn edit" title="تعديل" onclick="appManager.editMember('${member.id}')">
//                                 <i class="fas fa-edit"></i>
//                             </button>
//                             <button class="action-btn delete" title="حذف" onclick="appManager.deleteMember('${member.id}')">
...
//                     <td>
//                         <div class="action-buttons">
//                             <button class="action-btn view" title="عرض" onclick="appManager.viewUser(${user.id})">
//                                 <i class="fas fa-eye"></i>
//                             </button>
//                             <button class="action-btn edit" title="تعديل" onclick="appManager.editUser(${user.id})">
//                                 <i class="fas fa-edit"></i>
//                             </button>
//                             <button class="action-btn delete" title="حذف" onclick="appManager.deleteUser(${user.id})">
//                                 <i class="fas fa-trash"></i>
//                             </button>
//                         </div>
//                     </td>
